...
(function(global, factory) {
    ...
    //set default time zone aisa/seoul
    ...
    var realTimeScale = function(Chart$$1, moment$$1) {
        ...
        var realTimeScaleDefaultConfig = {
            ...
            time: {
                parser: 'Asia/Seoul', // false == a pattern string from http://momentjs.com/docs/#/parsing/string-format/ or a custom callback that converts its argument to a moment
